...
d <- round(FieldGoals/Games,digits=1)
d
rep(d,each=3)

matrix(Points, byrow=F)
FieldGoalAttempts
ggplot(FieldGoalAttempts)
library(ggplot2)
matplot(t(FieldGoalAttempts),type="o",pch=NULL,col=1:12, xlab="years",ylab="BasketBallplayers")
legend("bottomleft",c("KobeBryant","JoeJohnson","LeBronJames","CarmeloAnthony","DwightHoward","ChrisBosh","ChrisPaul","KevinDurant","DerrickRose","DwayneWade"),
col=1:12,text.col=1:12, border="black", angle=45)
?legend
